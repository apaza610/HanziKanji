...
# Get-ChildItem -Recurse -Filter *.svg | Where-Object { $_.PSIsContainer -eq $false -and (Get-Content $_.FullName | Select-String 'xlink:href.*data:') } | ForEach-Object { python extract_embedded_images_from_svg.py -p "tmp/$($_.BaseName)-" $_.FullName }
