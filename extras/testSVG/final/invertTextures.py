...
suffix_filter = input("Enter the suffix filter (e.g., _S), or leave blank to list all images: ").strip()
...
if os.path.isdir(folder_path):
    ...
    if image_files:
        ...
        print("\nInverting textures using ImageMagick...")
        ...
        for img in image_files:
            ...
            try:
                ...
                print(f"✔ Inverted saved: {output_name}")
            except subprocess.CalledProcessError as e:
                print(f"✖ Failed to invert {img}: {e}")
    else:
